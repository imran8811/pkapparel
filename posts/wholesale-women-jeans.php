...
<head>
    ...
    <meta name="keywords" content="Wholesale women jeans"/>
    ...
    <title>Wholesale Women Jeans</title>
    ...
    <div class="holder">
        <div class="detail-post">
            <div class="single-post">
                <div class="post-heading"><h1>Wholesale women jeans</h1> perks and benefits</div>
                <div class="image-holder">
                    <img src="../assets/images/posts/wholesale-women-jeans.jpg" alt="wholesale-women-jeans">
                </div>
                <div class="text-area">
                    <div class="content">
