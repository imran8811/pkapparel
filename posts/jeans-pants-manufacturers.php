    ...
    <div class="holder">
        <div class="detail-post">
            <div class="single-post">
                <div class="post-heading">Looking for <h1>jeans pants manufacturers</h1></div>
                <div class="image-holder">
                    <img src="../assets/images/posts/jeans-pants-manufacturers.jpg" alt="jeans-pants-manufacturers">
                </div>
                <div class="text-area">
                    <div class="content">
