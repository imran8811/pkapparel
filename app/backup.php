      ...
      <div class="products-outer">
        ...
        <div class="products">
          ...
          <div class="boxes">
            ...
            <div class="box mb-5">
              <a href="/shop/<?php echo $product['dept'] ?>/<?php echo $product['category'] ?>/<?php echo $product['slug'] . '-' . $product['article_no'] ?>" class="d-block" rel="noreferrer">
                <img
              ...
              <a
                ...
                href="/shop/<?php echo $product['dept'] ?>/<?php echo $product['category'] ?>/<?php echo $product['slug'] . '-' . $product['article_no'] ?>">
          ...
          <div class="text-end mb-5">
            <a href="/shop/men/jeans-pant" class="btn btn-primary">See all men jeans pants</a>
          </div>
        </div>
        <div class="products">
          ...
          <div class="text-end mb-5">
            <a href="/shop/chino-pant" class="btn btn-primary">See all men chino pants</a>
          </div>
        </div>
        <div class="products">
          ...
          <div class="text-end mb-5">
            <a href="/shop/men/cargo-trouser" class="btn btn-primary">See all men cargo trousers</a>
          </div>
        </div>
        <?php endif; ?>
      </div>
