...
class PostController extends Controller
{
  ...
  {
    $getFeaturedProducts = $this->postModel->getFeaturedProducts();
    return $getFeaturedProducts;
  }

  public function getFeaturedProductsByDept($dept)
  {
    $getFeaturedProductsByDept = $this->postModel->getFeaturedProductsByDept($dept);
    return $getFeaturedProductsByDept;
  }

  public function getLatestArticleNo()
  {
    $getLatestArticleNo = $this->postModel->getLatestArticleNo();
    return $getLatestArticleNo;
  }

  public function getProductsByDept($dept)
  {
    $getProductsByDept = $this->postModel->getProductsByDept($dept);
    return $getProductsByDept;
  }

  public function getProductsByDeptCategory($dept, $category)
  {
    $getProductsByDeptCategory = $this->postModel->getProductsByDeptCategory($dept, $category);
    return $getProductsByDeptCategory;
  }

  public function getProductByArticleNo($article_no)
  {
    $getProductByArticleNo = $this->postModel->getProductByArticleNo($article_no);
    return $getProductByArticleNo;
  }

  public function addProduct($data){
    $addProduct = $this->postModel->addProduct($data);
    if ($addProduct) {
      $res = [
        'type' => 'success',
        'p_id' => $addProduct,
