...
<div class="container-fluid page-content">
  <div class="row">
    ...
    <div class="mb-5">
      ...
      <h2 class="mb-3">What do we design as your jean manufacturer</h2>
      <p class="mb-2">Our specialized designers are well aware of the latest trends in each jean industry whether you need jeans for men, women, boys, and girls they produce premium jeans. Such jeans embody both a stylish look and durable stuff.</p>
      ...
      <h3 class="mb-3">Constant newness and skillful stitching</h3>
      ...
      <h3 class='mb-3'>Classic to advanced designs</h3>
      ...
      <h3 class='mb-3'>Various types of jeans that we offer</h3>
      <p class="mb-4">We know the fashion collection of jeans is very broad and it contains various types of jeans that are segmented as per the fashion needs of various niches. So, you can choose any type of jeans from our collection.</p>
      <p class='mb-1'>For men we offer:</p>
      <ul class='mb-4 list-group'>
        <li class='list-group-item'>Men&apos;s navy blue stretch jeans pant</li>
        <li class='list-group-item'>Men&apos;s blue stretch slim fit jeans pant</li>
        <li class='list-group-item'>Men&apos;s navy blue stretch chino pant</li>
        <li class='list-group-item'>Men&apos;s camel stretch cargo trousers</li>
        <li class='list-group-item'>Men&apos;s camo stretch cargo trousers</li>
        <li class='list-group-item'>Men&apos;s khaki stretch cargo trousers</li>
        <li class='list-group-item'>Men&apos;s olive stretch cargo trousers</li>
      </ul>
      <p class='mb-4'>We believe in producing all these jeans with high-quality materials and we offer these at affordable prices to customers and clothing brands.</p>
      <p class='mb-1'>For women we offer:</p>
      <ul class='mb-4 list-group'>
        <li class='list-group-item'>Women&apos;s navy blue stretch Capri jeans</li>
        <li class='list-group-item'>Skinny fit jeans</li>
        <li class='list-group-item'>Boot cut jeans</li>
        <li class='list-group-item'>Loose fit jeans</li>
        <li class='list-group-item'>Jegging fit jeans </li>
        <li class='list-group-item'>Original rise jeans</li>
        <li class='list-group-item'>Regular fit jeans</li>
      </ul>
      <p class='mb-4'>These are a few common types you can find in our collection of jeans and denim. But this list does not end here we can also make custom sizes, colors, and styles of jeans for men, women, boys, and girls.</p>
      <h3 class='mb-3'>Place your order with us right now</h3>
