...
<div class="container-fluid page-content">
  <div class="row">
    ...
    <div class="mb-5">
      ...
      <p class='mb-3'>Motorcycle jeans manufacturers produce jeans for motorcycles of all ages and sizes. However, which jeans fits you best is dependent upon your own experience. Denim jeans cannot function properly if they are not of the right fit. Therefore, the measurement of in seam and waist size plays a vital role to figure out which jeans won’t provide protection to the wrong parts during a crash leaving you injured.</p>
      <?php include_once('./app/views/shared/shop-ad.php'); ?>
      <h4>Dressed up to the nines</h4>
      <p class='mb-3'>It doesn&apos;t necessarily mean that the jeans that provide protection cannot have a sense of style to it. <strong>Motorcycle Jeans Manufacturers</strong> make sure that the denim jeans you are buying is in fashion and will remain a trend for the motorcycles.</p>
      <p class='mb-3'>There are different types of Motorcycle jeans with different styles. One of them is the jeans that can be worn all day in different situations. However, they offer limited protection against serious road injuries. Therefore, they are restricted to casual road motorcycles.</p>
